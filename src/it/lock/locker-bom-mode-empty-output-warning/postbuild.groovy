...
assertThat(buildLog)
    ...
    .contains("[WARNING] No dependencies were locked. This may indicate that locker was run on the wrong Maven project, for example a parent or aggregator project.")
