...
assertThat(buildLog, containsInRelativeOrder("[INFO] Configured with locker BOM Mode"))
assertThat(buildLog, containsInRelativeOrder("[INFO] No changes to the project pom.xml"))
assertThat(buildLog, hasItem(both(startsWith("[INFO] Creating ")).and(endsWith("/mvnpm-locker/target/its/lock/locker-bom-mode-update/locker/pom.xml"))))
